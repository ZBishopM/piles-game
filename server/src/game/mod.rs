...
pub use models::{
    ...
    // Solo lo que se usa fuera de `game`. Las ganancias de cambiar carta y de
    // llevarte una que ya tienes las decide `combo_gain_for_take`, ahí dentro.
    COMBO_WINDOW, COMBO_BASE_X100, FRENZY_STUN,
